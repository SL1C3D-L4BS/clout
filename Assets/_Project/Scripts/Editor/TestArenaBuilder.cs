    ...
    public static class TestArenaBuilder
    {
        ...
        public static void BuildTestArena()
        {
            ...
            EditorUtility.DisplayDialog("Clout", "Test Arena built!\n\n" +
                ...
                "• The Fillmore district (procedural Bay Area city block)\n" +
                "  - Road network with sidewalks & crosswalks\n" +
        ...
        {
            // Directional Light — warm golden hour Bay Area lighting
            ...
            // NOTE: Ground plane is now generated by ProceduralDistrictGenerator.
            // No ground plane, cover objects, or boundary walls here anymore.
            // The district generator creates its own NavMesh-ready ground,
            // road network, buildings, and urban furniture.

            // Combat cover objects placed in the starting area
            // (player spawn zone in center of district — keeps combat functional)
        ...
        private static void BuildDistrictSystem()
        {
            ...
            // Generate full city block with roads, buildings, furniture, and parks.
            // This replaces the flat grey arena with a living Bay Area neighborhood.
            GameObject districtGeo = ProceduralDistrictGenerator.GenerateDistrict(fillmore);

            Debug.Log("[Clout] District system created: DistrictManager + The Fillmore (procedurally generated).");
        }
